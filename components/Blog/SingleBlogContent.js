                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="blog-details-desc">
                                <div className="article-image">
                                    <img src={require("../../images/blog-details/single-blog.jpg")} alt="image" />
                                </div>
                                ...
                                <div className="article-content">
                                    ...
                                    <ul className="wp-block-gallery columns-3">
                                        <li className="blocks-gallery-item">
                                            <figure>
                                                <img src={require("../../images/blog-details/1.jpg")} alt="image" />
                                            </figure>
                                        </li>
                                        <li className="blocks-gallery-item">
                                            <figure>
                                                <img src={require("../../images/blog-details/2.jpg")} alt="image" />
                                            </figure>
                                        </li>
                                        <li className="blocks-gallery-item">
                                            <figure>
                                                <img src={require("../../images/blog-details/3.jpg")} alt="image" />
                                            </figure>
                                        </li>
                                    </ul>
